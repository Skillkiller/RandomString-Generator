...
<head>
	...
	<title>We've got some trouble | 403 - Zugriff verweigert</title>
...
<body>
	...
	<div class="cover">
		<h1>Zugriff verweigert <small>Error 403</small></h1>
		<p class="lead">Die Angeforderte Ressource benötigt erhöhte Rechte</p>
	</div>
	
		<footer>
		<p>Technical Contact: <?php echo "<a href=\"mailto:$adminmail\">$adminmail</a>" ?></p>
	</footer>
